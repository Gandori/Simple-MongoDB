...
class BaseCollection(Exceptions):
    ...
    async def update_one(
        ...
        Returns:
            ObjectId | None: The _id of the inserted document if an upsert took place. Otherwise ``None``.
    ...
    async def delete_one(self, where: Dict[str, Any]) -> None:
        ...
        Args:
            where (dict): A dictionary specifying the criteria for finding the document to delete.
